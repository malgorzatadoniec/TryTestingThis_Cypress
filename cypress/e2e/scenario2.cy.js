describe('Verify if buttons "Home" and "Contact" on navigation bar redirect user to correct pages', () => {
    ...
    it('Correct text in main page of contact page', () => {
        ...
        cy.get('.side > h2').should('contain', 'Thank you for using this Website :)')
        cy.get('.side > :nth-child(2)').should('contain', 'Source code for this website is available')
        cy.get('.side > :nth-child(3)').should('contain', 'Please suggest any improvements to this website. You can reach me')
    })
